...
/**
 * Using percent encoding (as defined in https://tools.ietf.org/html/rfc3986#section-2.1), transform
 * the input value into a url-safe encoding. This method should not be used with
 * application/x-www-form-urlencoded urls.
